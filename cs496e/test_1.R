...
{
  par(mfrow=c(2, 2))
  plot(actor_statistics$total_avg, ylim = c(30, 2000), main="배우 관심도 평균", xlab="배우#")
  plot(idol_statistics$total_avg, ylim = c(30, 2000), main="아이돌 관심도 평균", xlab="배우#")
  plot(singer_statistics$total_avg, ylim = c(30, 2000), main="가수 관심도 평균", xlab="배우#")
  plot(entertainer_statistics$total_avg, ylim = c(30, 2000), main="방송인 관심도 평균", xlab="배우#")
  par(mfrow=c(1,1))
}

{
  par(mfrow=c(2, 2))
  plot(actor_statistics$total_sd, ylim = c(30, 2000), main="배우 관심도 표준편차")
  plot(idol_statistics$total_sd, ylim = c(30, 2000), main="아이돌 관심도 표준편차")
  plot(singer_statistics$total_sd, ylim = c(30, 2000), main="가수 관심도 표준편차")
  plot(entertainer_statistics$total_sd, ylim = c(30, 2000), main="방송인 관심도 표준편차")
  par(mfrow=c(1,1))
}
